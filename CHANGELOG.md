...
### Fixed
- Fixed LessTokens website URL in documentation (updated from https://lesstokens.com to https://lesstokens.hive-hub.ai)
...
[0.1.1]: https://github.com/lesstokens/sdk-typescript/releases/tag/v0.1.1
